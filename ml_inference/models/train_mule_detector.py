...
Ingests Kaggle PaySim enriched dataset (data_simulation/data/mule_ml_training_dataset.parquet),
...
def load_dataset():
    ...
    from data_simulation.build_training_dataset import download_paysim_dataset, enrich_and_augment_features
...
def train_model():
    ...
    # Export to Treelite GTIL format for ultra-fast C-level inference (< 50 microseconds)
    try:
        import treelite
