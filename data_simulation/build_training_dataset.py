...
Outputs to data_simulation/data/mule_ml_training_dataset.parquet
"""
import sys
import os
...
def enrich_and_augment_features(df: pd.DataFrame, output_parquet: Path):
    ...
    print("Mapping transactions to Indian cybercrime corridors...")
    config_path = ROOT_DIR / "data_simulation" / "simulation_config.json"
    ...
    for is_f in df["isFraud"]:
        ...
        lats.append(round(c["lat_center"] + noise, 5))
        lons.append(round(c["lon_center"] + noise, 5))
